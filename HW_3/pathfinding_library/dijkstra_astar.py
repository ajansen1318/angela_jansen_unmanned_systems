...
# add a lil bitch for bool for dijk or ast


class DijkstraAstar:
    def __init__(self, grid: Grid, start_node: Node, end_node: Node) -> None:
        self.grid = grid
    ...
    def add_to_unvisited(self):
        ...
        for move in filtered_moves:
            ...
            new_cost = (
                ...
                + m.dist(move, [self.current_node.x, self.current_node.y])
    ...
    def find_path(self):
        ...
        while self.unvisited_nodes:
            ...
            # plt.plot(self.current_node.x, self.current_node.y, "bo")
            # plt.pause(0.01)
